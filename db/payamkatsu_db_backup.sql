...
CREATE TABLE `detail_pembelian` (
  `detail_pembelian_id` int(100) NOT NULL,
  `bahan_kode` varchar(20) NOT NULL,
  `detail_pembelian_qty` double NOT NULL,
  `pembelian_nota` varchar(100) NOT NULL,
  `detail_pembelian_jenis_ukuran` varchar(5) NOT NULL,
  `detail_pembelian_harga` int(100) NOT NULL,
  `detail_pembelian_subtotal` int(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Struktur dari tabel `detail_restok_produk`
--

CREATE TABLE `detail_restok_produk` (
...
CREATE TABLE `pembelian` (
  ...
  `penjualan_keterangan` int(11) NOT NULL,
...
CREATE TABLE `pengguna` (
  ...
  `pengguna_jenis` enum('Admin','Pegawai') NOT NULL DEFAULT 'Pegawai',
...
--
-- Indeks untuk tabel `detail_restok_produk`
--
ALTER TABLE `detail_restok_produk`
  ADD PRIMARY KEY (`detail_restok_produk_id`);
